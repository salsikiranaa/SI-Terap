...
@section('content')
    ...
    <section class="asset-dashboard">
        <div class="container">
            <h2 class="heading">Aset - Alat & Mesin</h1>
            <hr>
        ...
        <div class="filter-container">
            <select id="bpsip" placeholder="BPTP">
                ...
                <option value="bpsip1">SUMUT</option>
                <option value="bpsip1">SUMBAR</option>
                <option value="bpsip1">RIAU</option>
                <option value="bpsip1">KEPRI</option>
                <option value="bpsip1">JAMBI</option>
                <option value="bpsip1">SUMSEL</option>
