...
namespace App\Http\Controllers\pengelolaanBenih;

use App\Http\Controllers\Controller; // Tambahkan ini
use Illuminate\Http\Request;

class provinceBenihController extends Controller
{
    public function show($province)
    {
        ...
        // Kirim data ke view
        return view('pengelolaan.tabelBenih', compact('province', 'provinceName'));
    }
}
