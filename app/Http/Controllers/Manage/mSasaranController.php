...
class mSasaranController extends Controller
{
    ...
    public function store(Request $request) {
        $request->validate([
            'name' => 'required|string|max:255|unique:m_sasaran'
        ], [
            ...
            'name.unique' => 'Sasaran name already exists'
        ]);
        $sasaran = mSasaran::create(['name' => $request->name]);
        // return 'created';
        return redirect()->route('manage.sasaran.view')->with('success', 'data created');
    }
    ...
    public function update($id, Request $request) {
        ...
        // return 'updated';
        return redirect()->route('manage.sasaran.view')->with('success', 'data updated');
    }
    ...
    public function destroy($id) {
        ...
        $sasaran->delete();
        // return 'deleted';
        return redirect()->route('manage.sasaran.view')->with('success', 'data deleted');
    }
}
