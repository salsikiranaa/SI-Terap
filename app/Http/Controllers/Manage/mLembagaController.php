...
class mLembagaController extends Controller
{
    ...
    public function store(Request $request) {
        $request->validate([
            'name' => 'required|string|max:255|unique:m_lembaga'
        ], [
            ...
            'name.unique' => 'Lembaga name already exists'
        ]);
        $lembaga = mLembaga::create(['name' => $request->name]);
        // return 'created';
        return redirect()->route('manage.lembaga.view')->with('success', 'data created');
    }
    ...
    public function update($id, Request $request) {
        ...
        // return 'updated';
        return redirect()->route('manage.lembaga.view')->with('success', 'data updated');
    }
    ...
    public function destroy($id) {
        ...
        $lembaga->delete();
        // return 'deleted';
        return redirect()->route('manage.lembaga.view')->with('success', 'data deleted');
    }
}
